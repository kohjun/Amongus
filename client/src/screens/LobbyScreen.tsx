...
const styles = StyleSheet.create({
  ...
  settingInput:     { backgroundColor: '#c8f0e9', borderWidth: 1, borderColor: '#2a2a2a', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: '#f0f0f0', fontSize: 15, width: 80, textAlign: 'right' },
