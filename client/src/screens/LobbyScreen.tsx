...
const styles = StyleSheet.create({
  ...
  headerSub:        { fontSize: 13, color: '#1a1a1a', marginTop: 4 },
  loader:           { flex: 1 },
  list:             { padding: 16, gap: 10 },
  roomCard:         { backgroundColor: '#c8f0e9', borderRadius: 14, borderWidth: 1, borderColor: '#1e1e1e', padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  roomCardFull:     { opacity: 0.5 },
  roomCardLeft:     { gap: 10 },
  roomIdPill:       { backgroundColor: '#b0e8e0', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, alignSelf: 'flex-start' },
  roomIdText:       { fontSize: 11, color: '#1a1a1a', fontFamily: 'Courier New', letterSpacing: 1 },
  ...
  avatarMore:       { backgroundColor: '#b0e8e0' },
  avatarMoreText:   { fontSize: 9, color: '#1a1a1a' },
  roomCardRight:    { alignItems: 'flex-end', gap: 8 },
  roomCount:        { fontSize: 22, fontWeight: '700', color: '#1a1a1a' },
  roomCountMax:     { fontSize: 14, fontWeight: '400', color: '#1a1a1a' },
  ...
  fullBadge:        { backgroundColor: '#b0e8e0', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 5 },
  fullBadgeText:    { fontSize: 11, color: '#1a1a1a', letterSpacing: 1 },
  empty:            { alignItems: 'center', paddingTop: 80, gap: 8 },
  emptyIcon:        { fontSize: 48 },
  emptyText:        { fontSize: 16, color: '#1a1a1a', fontWeight: '500' },
  emptySubText:     { fontSize: 13, color: '#1a1a1a' },
  ...
  modalCard:        { backgroundColor: '#c8f0e9', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 24, borderTopWidth: 1, borderTopColor: '#1e1e1e', gap: 16 },
  modalTitle:       { fontSize: 20, fontWeight: '700', color: '#1a1a1a', marginBottom: 4 },
  settingRow:       { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  settingLabel:     { fontSize: 14, color: '#1a1a1a', flex: 1 },
  settingInput:     { backgroundColor: '#c8f0e9', borderWidth: 1, borderColor: '#2a2a2a', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, color: '#1a1a1a', fontSize: 15, width: 80, textAlign: 'right' },
