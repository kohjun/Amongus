...
const styles = StyleSheet.create({
  ...
  winnerReason:         { fontSize: 14, color: '#1a1a1a', marginTop: 4 },
  section:              { gap: 12 },
  sectionTitle:         { fontSize: 12, fontWeight: '600', color: '#1a1a1a', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  playerRole:           { fontSize: 11, color: '#1a1a1a' },
  ...
  lobbyBtnText:         { fontSize: 15, fontWeight: '600', color: '#1a1a1a' },
});
