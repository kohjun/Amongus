...
export default function ResultScreen({ navigation, route }: ResultScreenProps) {
  ...
  const crewPlayers = result.players.filter(p => p.role === 'crew');
              ...
              <View key={player.userId} style={styles.playerRow}>
                <View style={[
                  ...
                  player.role === 'impostor'
                    ? styles.playerAvatarImpostor
                    : styles.playerAvatarCrew,
                ]}>
                ...
                <View style={styles.playerStatus}>
                  {player.isAlive ? (
                    <View style={styles.aliveBadge}>
                      <Text style={styles.aliveBadgeText}>생존</Text>
                    </View>
                  ) : (
                    <View style={styles.deadBadge}>
                      <Text style={styles.deadBadgeText}>사망</Text>
                    </View>
                  )}
                </View>
              </View>
